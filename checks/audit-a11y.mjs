...
const classColors = {
  ...
  "b2bea-marketing-nav__actions": {},
  "b2bea-marketing-nav__brand": {},
  "b2bea-marketing-nav__links": {},
  "b2bea-page-hero": { bg: "primary", fg: "inverse" },
  "b2bea-page-hero--home": { bg: "primary", fg: "inverse" },
  "b2bea-footer": { bg: "primary", fg: "inverse" },
  "b2bea-footer__grid": {},
  "b2bea-footer__heading": { fg: "inverse" },
  "b2bea-footer__legal": { fg: "inverse" },
  "b2bea-footer__list": {},
  ...
  "b2bea-people-card__avatar": {},
  "b2bea-people-card__name": { fg: "text" },
  "b2bea-people-card__role": { fg: "muted" },
  "b2bea-people-card__tagline": { fg: "muted" },
  "b2bea-resource-card": { bg: "card", fg: "text" },
  "b2bea-resource-card__category": { fg: "muted" },
  "b2bea-resource-card__excerpt": { fg: "muted" },
  "b2bea-resource-card__footer": {},
  "b2bea-resource-card__media": {},
  "b2bea-resource-card__title": { fg: "text" },
  "b2bea-testimonial": { bg: "card", fg: "text" },
  "b2bea-testimonial__attribution": {},
  "b2bea-testimonial__name": { fg: "text" },
  "b2bea-testimonial__photo": {},
  "b2bea-testimonial__quote": { fg: "text" },
  "b2bea-testimonial__role": { fg: "muted" },
  ...
  "b2bea-app-sidebar__link": { fg: "muted" },
  "b2bea-app-sidebar__link--active": { bg: "primary", fg: "inverse" },
  "b2bea-app-sidebar__nav": {},
  "b2bea-app-sidebar__section": {},
  "b2bea-app-topbar": { bg: "background" },
  "b2bea-app-topbar__actions": {},
  "b2bea-app-topbar__brand": { fg: "primary" },
  "b2bea-app-topbar__menu-toggle": {},
  "b2bea-app-topbar__search": {},
  ...
  "b2bea-grid": {},
  "b2bea-stat-strip": {},
  "b2bea-stat-strip__item": {},
  "b2bea-stat-strip__label": { fg: "muted" },
  "b2bea-stat-strip__value": { fg: "text" },
  "b2bea-persona-selector": {},
  "b2bea-persona-selector__icon": {},
  "b2bea-persona-selector__item": {},
  "b2bea-persona-selector__label": { fg: "text" },
  "b2bea-persona-selector__sublabel": { fg: "muted" },
  "b2bea-skeleton": { bg: "surface" },
  "b2bea-table": {},
  "b2bea-kpi": {},
  "b2bea-kpi__delta": { fg: "muted" },
  "b2bea-kpi__delta--down": { fg: "accent" },
  "b2bea-kpi__delta--up": { fg: "success" },
  "b2bea-kpi__label": { fg: "muted" },
  "b2bea-kpi__value": { fg: "text" },
  "b2bea-activity": {},
  "b2bea-activity-row": {},
  "b2bea-activity-row__actor": { fg: "text" },
  "b2bea-activity-row__body": {},
  "b2bea-activity-row__icon": {},
  "b2bea-activity-row__time": { fg: "muted" },
  "b2bea-action-list": {},
  "b2bea-action-list__item": {},
  "b2bea-action-list__item-arrow": {},
  "b2bea-action-list__item-icon": {},
  "b2bea-page-header": {},
  "b2bea-page-header__actions": {},
  "b2bea-page-header__eyebrow": { fg: "muted" },
  "b2bea-page-header__subtitle": { fg: "muted" },
  "b2bea-page-header__title": { fg: "text" },
  "b2bea-logo": {},
  "b2bea-logo--horizontal": {},
